      ...
      <div className="mx-auto max-w-lg px-4 py-6">
        ...
        >
          ...
          <div className="mb-5 flex items-center justify-center gap-6">
            <button
              type="button"
              disabled={isSubscription || maintenanceOn}
            ...
            <div className="text-center">
              ...
              <p className="text-xs text-slate-500">
                Ghc{pricePerGallon.toFixed(2)} each
              </p>
            </div>
            <button
              type="button"
          ...
          <div className="mb-4 flex gap-2">
            <input
              ...
              className="flex-1 rounded-xl border px-3 py-2.5 text-sm uppercase text-black"
            />
            <button
              type="button"
              onClick={applyPromo}
              className="rounded-xl border px-4 text-sm font-semibold text-[#0077C8]"
            >
              Apply
            </button>
          </div>
          {promoApplied && (
            <p className="mb-3 text-xs text-green-600">
              Promo applied: +{promoApplied.rewardValue} free gallons (one-time
              per account)
            </p>
          )}
