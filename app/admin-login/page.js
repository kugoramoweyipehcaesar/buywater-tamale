...
export default function AdminLoginPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#D6EAF8] px-4 py-10">
      ...
      <div className="mt-6 w-full max-w-[400px] rounded-2xl bg-white p-6 shadow-lg sm:p-8">
        ...
        >
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                autoComplete="off"
                className="w-full rounded-xl border border-slate-200 bg-slate-50 py-2.5 pl-10 pr-3 text-sm outline-none focus:border-[#0077C8] focus:ring-2 focus:ring-[#0077C8]/20"
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-xl border border-slate-200 bg-slate-50 py-2.5 pl-10 pr-10 text-sm outline-none focus:border-[#0077C8] focus:ring-2 focus:ring-[#0077C8]/20"
                placeholder="••••••••"
              />
              <button
                type="button"
          ...
          <button
            type="submit"
            disabled={loading}
            className="flex w-full items-center justify-center gap-2 rounded-xl bg-[#0077C8] py-2.5 text-sm font-semibold text-white hover:bg-[#0066ad] disabled:opacity-60"
          >
            {loading ? (
              <>
      ...
      <Link href="/" className="mt-6 text-sm text-[#0077C8] hover:underline">
        ← Back to site
      </Link>
    </div>
  );
