    ...
    >
      <div className="mx-auto flex max-w-5xl items-center justify-between gap-3 px-4 py-3">
        ...
        <nav className="hidden items-center gap-5 md:flex">
          <a
            href="/#how-it-works"
            className={`text-sm font-medium ${onHome ? "text-white/90 hover:text-white" : "text-slate-600 hover:text-[#0077C8] dark:text-zinc-300 dark:hover:text-sky-400"}`}
          >
            How It Works
          </a>
          <a
              ...
              <Link
                ...
                className={`rounded-lg px-2.5 py-1.5 text-xs font-semibold ${
                  onHome
                    ...
                    : "bg-[#0077C8]/10 text-[#0077C8] hover:bg-[#0077C8]/20 dark:bg-sky-500/15 dark:text-sky-400"
                }`}
              >
                Order
              </Link>
