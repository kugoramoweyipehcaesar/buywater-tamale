...
/** Rider role — delivery staff, not full admin */
export function isRiderRole(role) {
  return String(role || "").toUpperCase() === "RIDER";
}

/** Admin or Rider — can view/update order queue */
export function isStaffRole(role) {
  const r = String(role || "").toUpperCase();
  return ADMIN_ROLES.includes(r) || r === "RIDER";
}
...
/** Require ADMIN, SUPER_ADMIN, or RIDER */
